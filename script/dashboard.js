...
const mensajes = [
    "Eres esa persona que siempre quiero ver. 💖",
    "Contigo, cada momento es especial. 🌟",
    "Tu amor un gran regalo de la vida. 🏆",
    "Eres mi hoy, mi mañana y mi siempre. 🌹",
    "Gracias por hacerme tan feliz. 😊",
    "Eres quien me demostro que si exite la lealtad y sinceridad. ☀️",
    "Eres ese apoyo que siempre esta para. 😊",
    "Eres mi JUNG. 💓"
];
